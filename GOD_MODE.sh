...
echo "=== ComfyUI запускает ( ГОДЕ МОДЕ ) ==="
...
function provisioning_start() {
    ...
    download_hf "wan2.2_t2v_low_noise_14B_fp16.safetensors" "$COMFYUI_DIR/models/diffusion_models"
    download_hf "wan2.2_animate_14B_bf16.safetensors" "$COMFYUI_DIR/models/diffusion_models"
    ...
    # LoRAs
    download_hf "wan2.2_animate_14B_relight_lora_bf16.safetensors" "$COMFYUI_DIR/models/loras"
    download_hf "i2v_lightx2v_low_noise_model.safetensors" "$COMFYUI_DIR/models/loras"
    download_hf "pussy_LoRA.safetensors" "$COMFYUI_DIR/models/loras"
    
    # Upscale & Checkpoints
    download_hf "1xSkinContrast-SuperUltraCompact.pth" "$COMFYUI_DIR/models/upscale_models"
    download_hf "rife49.pth" "$COMFYUI_DIR/models/checkpoints"
    ...
    echo "HERWAM настроил всё под GOD_MODE!"
}
