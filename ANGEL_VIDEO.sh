...
echo "=== ComfyUI запускает ( Angel Video ) ==="
...
function provisioning_start() {
    ...
    echo "##############################################"
    echo "# РЕЖИМ: ANGEL_MODE                          #"
    echo "##############################################"
    
    download_hf "z_image_turbo_bf16.safetensors" "$COMFYUI_DIR/models/diffusion_models"
    download_hf "qwen_3_4b.safetensors" "$COMFYUI_DIR/models/text_encoders"
    download_hf "flux_vae.safetensors" "$COMFYUI_DIR/models/vae"
    download_hf "Z-Image-Turbo-Fun-Controlnet-Union.safetensors" "$COMFYUI_DIR/models/model_patches"
    download_hf "lightx2v_I2V_14B_480p_cfg_step_distill_rank64_bf16.safetensors" "$COMFYUI_DIR/models/loras"
    download_hf "Wan21_SteadyDancer_fp8_e4m3fn_scaled_KJ.safetensors" "$COMFYUI_DIR/models/diffusion_models"
    download_hf "Wan2_1_VAE_bf16.safetensors" "$COMFYUI_DIR/models/vae"
    download_hf "clip_vision_h.safetensors" "$COMFYUI_DIR/models/clip_vision"
    download_hf "umt5_xxl_fp16.safetensors" "$COMFYUI_DIR/models/text_encoders"
    download_hf "umt5_xxl_fp8_e4m3fn_scaled.safetensors" "$COMFYUI_DIR/models/clip"
    download_hf "ema_vae_fp16.safetensors" "$COMFYUI_DIR/models/SEEDVR2"
    download_hf "seedvr2_ema_3b-Q4_K_M.gguf" "$COMFYUI_DIR/models/SEEDVR2"
    download_hf "pussy_LoRA.safetensors" "$COMFYUI_DIR/models/loras"
